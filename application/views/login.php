...
<style>
        .bg-login-image {
            background-image: url("<?= base_url('sb-admin/img/box.png'); ?>");
            background-repeat: no-repeat; 
            background-size: 85%;
        }
		.bg-gradient-primary {
			background-color: #333; /* change to a dark gray color */
			background-image: none; /* remove the gradient effect */
		}
    </style>
</head>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center mb-4">
                                <h1 class="h4 text-gray-900">ELEKTROSTORE</h1>
                                <span class="text-muted">Pilihan Terbaik untuk Anda</span>
			                            </div>
																		<div class="row">
																			<div class="col-lg-12">
																				<div class="p-5">
